<?php 
    ...
    $url = $protocol . '/back/student_grade_shower/';
    ...
    $auData =  curl_request_input($protocol . '/back/fetch_auto_grader_comment_by_uniq_exam_id.php', array('unique_id' => $POSTunique));
